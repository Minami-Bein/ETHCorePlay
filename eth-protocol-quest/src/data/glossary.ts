export const glossary = [
  ...
  { term: 'Finality', desc: '[Mainnet] 区块达到经济上强不可逆（回滚概率极低）的状态。' },
  ...
  { term: 'Rollup', desc: '[Mainnet] 常见 L2 扩容范式：L2 执行，结果在 L1 结算/锚定；不同方案安全模型不同。' },
  ...
  { term: 'ForkchoiceUpdated', desc: '[Mainnet] Engine API 中 forkchoiceUpdated 系列调用，用于 CL 向 EL 同步链头选择。' },

  { term: 'PBS', desc: '[Roadmap/Ecosystem] Proposer-Builder Separation：提议者与构建者分离方向，生态中已有相关实践。' },
  { term: 'Inclusion List', desc: '[Research/Roadmap] 提升交易最低可包含性的机制设计，仍在持续讨论与演进。' },
  ...
  { term: 'Verkle Tree', desc: '[Research/Roadmap] 用于优化状态证明体积与验证效率的承诺结构方向，尚未主网全面切换。' },
  { term: 'Stateless Ethereum', desc: '[Research/Roadmap] 通过 witness 降低对完整状态依赖的方向，仍处于推进阶段。' },
  ...
  { term: 'Builder Relay', desc: '[Ecosystem Practice] 在构建者与提议者之间传递候选区块的中继角色，属于生态实践层。' },
  { term: 'Blob Gas Price', desc: 'EIP-4844 中 blob 资源的动态价格信号。' },
  { term: 'Data Availability Sampling (DAS)', desc: '[Research/Roadmap] 通过抽样验证数据可用性的技术路线，更多见于模块化扩容研究。' },
  ...
  { term: 'Escape Hatch', desc: '[Depends on Design] L2 异常时的用户退出兜底机制，具体可用性取决于各方案设计。' },
  ...
  { term: 'Finality Gadget', desc: '[Concept] 提供最终性保证的机制组件（如 checkpoint finality）。' },
